...
DEFAULT_TESTS=(smoke go node deno bun rust python java kotlin groovy scala clojure zig julia crystal dart lua haskell x_script json_output ruby)
FAST_TESTS=(smoke go node deno bun rust python zig julia crystal dart lua x_script json_output)
