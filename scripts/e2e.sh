...
DEFAULT_TESTS=(smoke go node deno bun rust python java kotlin groovy zig julia crystal ruby)
FAST_TESTS=(smoke go node deno bun rust python zig julia crystal)
