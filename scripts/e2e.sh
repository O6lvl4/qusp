...
DEFAULT_TESTS=(smoke go node deno bun rust python java kotlin groovy scala clojure zig julia crystal dart lua haskell erlang elixir install_hardening x_script inline_metadata farm json_output ruby)
